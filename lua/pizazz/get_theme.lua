local function apply_highlights(colors)
	...
	vim.api.nvim_set_hl(0, "Special", { fg = colors.primary })
	...
	vim.api.nvim_set_hl(0, "Cursor", { fg = colors.bg_main, bg = colors.cursor_bg })
	...
	vim.api.nvim_set_hl(0, "@string", { fg = colors.success })
	vim.api.nvim_set_hl(0, "@variable", { fg = colors.primary })
	...
	vim.api.nvim_set_hl(0, "NormalNC", { fg = colors.sidebar_fg, bg = colors.bg_alt })
